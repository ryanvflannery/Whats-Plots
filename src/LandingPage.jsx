        ...
        <div className="relative isolate px-0 lg:px-0" style={customStyles}>
          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            ...
            <div className="mx-auto max-w-2xl py-1 sm:py-1 lg:py-1 text-center">
              ...
              <br></br>
              <div
                className="relative isolate px-0 lg:px-0"
                style={customStyles2}
              >
                <h2 style={{ maxWidth: "800px", color: "black" }}>
                  <b>
                    Introducing Plots, where we turn every 'I don't know, what
                    do you want to do?' into 'I can't believe we just did that!'
                  </b>
                </h2>
              </div>
              <p className="mt-6 text-lg leading-12 text-gray-600 max-w-5xl">
                Transform vague ideas into unforgettable experiences with Plots,
                the user-friendly web application that simplifies event planning
                among friends, to maximize participation, and fostering stronger
                social connections through seamless organization.
              </p>
              <br></br>
              <div style={{ display: "flex", flex: 1 }}>
                <a href="https://github.com/abccodes/CalHacks2023">
                  <img src="/src/githublogo.png" width="120px" height="120px" />
                </a>
                <div style={{ marginLeft: "340px" }}>
                  <a href="https://devpost.com/software/what-s_plots">
                    <img
                      src="/src/devpostlogo.png"
                      width="120px"
                      height="120px"
                    />
                  </a>
